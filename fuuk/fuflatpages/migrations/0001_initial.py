    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text=fuuk.common.forms.get_markdownx_help_text, verbose_name='content', blank=True)),
                ('content_en', models.TextField(help_text=fuuk.common.forms.get_markdownx_help_text, null=True, verbose_name='content', blank=True)),
                ('content_cs', models.TextField(help_text=fuuk.common.forms.get_markdownx_help_text, null=True, verbose_name='content', blank=True)),
